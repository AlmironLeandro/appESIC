...
import FormularioTutorOCoordinador from './FormularioTutorOCoordinador';
...
const InicioCoordinador = () => {
  ...
  return (
    <Fragment>
      ...
      <div className={classes.root}>
        ...
        >
          ...
          <List>
            ...
            <ListItem button onClick={() => agregarCoordinador()}>
              <ListItemIcon> <GroupAddIcon /> </ListItemIcon>
              <ListItemText primary={"Cargar coordinador"} />
            </ListItem>
      ...
      {tutor ?
        <FormularioTutorOCoordinador
          setCallback={setCallback}
          queEs={{ nombre: "Tutor", id: 2 }}
      ...
      {coordinador ?
        <FormularioTutorOCoordinador
          queEs={{ nombre: "Coordinador", id: 3 }}
          setCallback={setCallback}
          avisoCallback={setCoordinador}
          carreras={carreras}
        /> : ''
      }
